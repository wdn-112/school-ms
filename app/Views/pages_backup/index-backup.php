      ...
      <section class=hero>
        <div class="container d-lg-flex align-items-center">
          <div class=hero_content>
            ...
            <p class=hero_content-text data-aos=fade-up data-aos-delay=50>Today, more than 48,000 people have already studied at our university in various fields: programming, photography, marketing and management</p>
          ...
          <div class="hero_media col-lg-6">
            <lottie-player src=lottie/hero.json background=404.html speed=1 style="width: 100%; height: 100%" loop autoplay></lottie-player>
          </div>
        </div>
      </section>
      <div class=features>
              ...
              <div class=card>
                <div class=content>
                  ...
                  <div class=card_main>
                    ...
                    <p class=card_main-text>Sed a eros sodales diam sagittis faucibus. Cras id erat nisl. Lorem tempus rhoncus sit tortor.</p>
                  </div>
                </div>
              </div>
            </li>
              ...
              <div class=card>
                <div class=content>
                  ...
                  <div class=card_main>
                    ...
                    <p class=card_main-text>Donec urna massa, cursus venenatis ipsum et, tempus rhoncus tortor. Lorem ipsum dolor.</p>
                  </div>
                </div>
              </div>
            </li>
              ...
              <div class=card>
                <div class=content>
                  ...
                  <div class=card_main>
                    ...
                    <p class=card_main-text>Sed a eros sodales diam sagittis faucibus. Cras id erat nisl. Lorem ipsum dolor sit lorem amet.</p>
                  </div>
                </div>
              </div>
            </li>
      ...
      <section class=promo>
        <div class="container d-flex flex-column-reverse flex-lg-row justify-content-lg-end">
          <div class=promo_media>
            <lottie-player src=lottie/scene.json background=404.html speed=1 style="width: 100%; height: 100%" loop autoplay></lottie-player>
          </div>
          <div class=promo_content>
            <h2 class=promo_content-header data-aos=fade-left>Learn and get a profession online</h2>
            <p class=promo_content-text data-aos=fade-up data-aos-delay=50>Morbi tempor eleifend condimentum. Etiam mollis urna et massa tempus vulputate. Nunc sed nisl est. Donec non consectetur elit. Praesent accumsan elit urna, eget mattis turpis aliquam a. In sagittis bibendum consequat. Quisque porta volutpat ligula sit amet varius</p>
      ...
      <section class=about>
        <div class=container>
          <div class=about_deco>
            <lottie-player src=lottie/wave.json background=404.html speed=1 style="width: 100%; height: 100%" loop autoplay></lottie-player>
          </div>
            ...
            <div class=content>
              ...
              <ul class=about_main-list>
                ...
                <li class=about_main-list_item data-aos=fade-up data-aos-delay=100>
                  <i class="icon-check icon"></i>
                  <div class=content>
                    <h5 class=title>After completing the course and completing the tasks, you will receive a certificate</h5>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div class=about_review data-aos=zoom-in>
            <div class=about_review-wrapper>
              ...
              <div class=main>
                ...
                <q class="main_review quote">“Mauris tellus lorem, tempus sed nibh at, varius convallis mi. sed scelerisque odio neque a lacus. Ut consectetur ligula. ed rhoncus sapien eget feugiat.”</q>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class=popular>
        <div class=container>
          <div class=popular_header>
            ...
            <p class=popular_header-text data-aos=fade-down>Sed a eros sodales diam sagittis faucibus. Cras id erat nisl. Fusce faucibus nulla sed finibus egestas. Vestibulum purus magna.</p>
          </div>
                ...
                <div class=bottom>
                  <ul class=bottom_list>
                    <li class="bottom_list-item d-flex align-items-start">
                      ...
                      <p class=bottom_list-item_text>Mauris tellus lorem, tempus sed nibh at, varius convallis mi</p>
                    </li>
                    <li class="bottom_list-item d-flex align-items-start">
                      <i class="bottom_list-item_marker icon-circle"></i>
                      <p class=bottom_list-item_text>Aenean tristique sodales enim, et consequat velit. Morbi sit amet lorem sapien</p>
                    </li>
                  </ul>
                  <a class="bottom_btn btn btn--bordered btn--arrow" href=course.html>sign up for a course <i class="icon-arrow-right-solid icon"></i>
                  </a>
                </div>
              </div>
            </li>
      ...
      <div class=banner>
        ...
        <div class="container d-lg-flex align-items-center">
          <div class=banner_content>
            <h4 class=banner_content-title data-aos=fade-up>Unlimited access to educational materials and lectures for subscribers</h4>
          ...
          <div class=banner_media>
            <picture>
              <source data-srcset=img/banners/index.webp srcset=img/banners/index.webp>
              <img class=lazy data-src=img/banners/index.jpg src=img/banners/index.jpg alt=media>
            </picture>
          </div>
        </div>
      </div>
