...
<html lang=en>
  <head>
    ...
    <title>Events and Lectures | Edison</title>
  ...
  <body>
    ...
    <header class=header data-page=events>
      ...
      <div class=page_main>
        ...
        <div class=container>
          <div class=content-wrapper>
            <h1 class=page_main-header>Events and Lectures</h1>
      ...
      <section class=event>
        <div class="container d-lg-flex justify-content-between">
          <div class=event_media>
            <picture>
              <source data-srcset=img/events/timer.webp srcset=img/events/timer.webp>
              <img class=lazy data-src=img/events/timer.jpg src=img/events/timer.jpg alt=media>
            </picture>
          ...
          <div class=event_main>
            <h3 class=event_main-title>Take the next step towards achieving personal and professional goals</h3>
            <span class="event_main-price event-price text">Free for subscribers</span>
            <p class=event_main-text>Vivamus sagittis nulla eget tempus dapibus. Duis volutpat neque ipsum, eget efficitur justo venenatis eget. Proin sodales cursus arcu, ac posuere purus lobortis nec. Maecenas quis est eget massa fringilla maximus sit amet vel est. Morbi quis orci nec mauris auctor iaculis. Maecenas tristique, purus in laoreet ultrices</p>
            <div class="event_main-timer timer d-flex justify-content-start">
              <div class="timer_block d-flex flex-column justify-content-center">
                <span class=timer_block-number id=days>22</span>
                <span class="timer_block-text text text--sm">days</span>
              </div>
              <span class=timer_block-separator>:</span>
              <div class="timer_block d-flex flex-column justify-content-center">
                <span class=timer_block-number id=hours>22</span>
                <span class="timer_block-text text text--sm">hours</span>
              </div>
              <span class=timer_block-separator>:</span>
              <div class="timer_block d-flex flex-column justify-content-center">
                <span class=timer_block-number id=minutes>00</span>
                <span class="timer_block-text text text--sm">minutes</span>
              </div>
              <span class=timer_block-separator>:</span>
              <div class="timer_block d-flex flex-column justify-content-center">
                <span class=timer_block-number id=seconds>59</span>
                <span class="timer_block-text text text--sm">seconds</span>
              </div>
            </div>
      ...
      <section class=list>
        <div class=container>
          <ul class="list_events d-md-flex flex-wrap">
            <li class="list_events-card col-md-6 col-lg-4" data-aos=fade-up data-order=1>
              <div class="card-wrapper d-flex flex-column">
                <div class=media>
                  <picture>
                    <source data-srcset=img/events/01.webp srcset=img/events/01.webp>
                    <img class=lazy data-src=img/events/01.jpg src=img/events/01.jpg alt=media>
                  </picture>
                  <span class=event-date>
                    <span class=day>23</span>
                    <span class=month>Aug</span>
                ...
                <div class="main d-flex flex-column justify-content-between">
                  <span class="main_price event-price">Free for subscribers</span>
                  <h4 class=main_title>Webinar - Anti-Crisis Strategy for Business Success</h4>
                  <p class=main_text>Vestibulum eget magna aliquet, ultrices arcu non, suscipit urna. Aliquam porta, lorem eu dictum rutrum</p>
                  <a class="main_btn btn btn--bordered btn--arrow" href=#>sign up for a course <i class="icon-arrow-right-solid icon"></i>
                  </a>
                </div>
              </div>
            </li>
            <li class="list_events-card col-md-6 col-lg-4" data-aos=fade-up data-order=2>
              <div class="card-wrapper d-flex flex-column">
                <div class=media>
                  <picture>
                    <source data-srcset=img/events/02.webp srcset=img/events/02.webp>
                    <img class=lazy data-src=img/events/02.jpg src=img/events/02.jpg alt=media>
                  </picture>
                  <span class=event-date>
                ...
                <div class="main d-flex flex-column justify-content-between">
                  <span class="main_price event-price">$ 20</span>
                  <h4 class=main_title>Lection - Supply Chain Excellence Master</h4>
                  <p class=main_text>Vestibulum eget magna aliquet, ultrices arcu non, suscipit urna. Aliquam porta, lorem eu dictum rutrum</p>
                  <a class="main_btn btn btn--bordered btn--arrow" href=#>sign up for a course <i class="icon-arrow-right-solid icon"></i>
                  </a>
                </div>
            ...
            <li class="list_events-card col-md-6 col-lg-4" data-aos=fade-up data-order=3>
              <div class="card-wrapper d-flex flex-column">
                <div class=media>
                  <picture>
                    <source data-srcset=img/events/03.webp srcset=img/events/03.webp>
                    <img class=lazy data-src=img/events/03.jpg src=img/events/03.jpg alt=media>
                  </picture>
                  <span class=event-date>
                ...
                <div class="main d-flex flex-column justify-content-between">
                  <span class="main_price event-price">Free for subscribers</span>
                  <h4 class=main_title>Home office: an effective tool to ensure business</h4>
                  <p class=main_text>Vestibulum eget magna aliquet, ultrices arcu non, suscipit urna. Aliquam porta, lorem eu dictum rutrum</p>
                  <a class="main_btn btn btn--bordered btn--arrow" href=#>sign up for a course <i class="icon-arrow-right-solid icon"></i>
                  </a>
                </div>
            ...
            <li class="list_events-card col-md-6 col-lg-4" data-aos=fade-up data-order=4>
              <div class="card-wrapper d-flex flex-column">
                <div class=media>
                  <picture>
                    <source data-srcset=img/events/04.webp srcset=img/events/04.webp>
                    <img class=lazy data-src=img/events/04.jpg src=img/events/04.jpg alt=media>
                  </picture>
                  <span class=event-date>
                    <span class=day>23</span>
                    <span class=month>Aug</span>
                ...
                <div class="main d-flex flex-column justify-content-between">
                  <span class="main_price event-price">Free for subscribers</span>
                  <h4 class=main_title>Computer science curriculum that makes coding easy</h4>
                  <p class=main_text>Vestibulum eget magna aliquet, ultrices arcu non, suscipit urna. Aliquam porta, lorem eu dictum rutrum</p>
                  <a class="main_btn btn btn--bordered btn--arrow" href=#>sign up for a course <i class="icon-arrow-right-solid icon"></i>
                  </a>
                </div>
            ...
            <li class="list_events-card col-md-6 col-lg-4" data-aos=fade-up data-order=5>
              <div class="card-wrapper d-flex flex-column">
                <div class=media>
                  <picture>
                    <source data-srcset=img/events/05.webp srcset=img/events/05.webp>
                    <img class=lazy data-src=img/events/05.jpg src=img/events/05.jpg alt=media>
                  </picture>
                  <span class=event-date>
                    <span class=day>01</span>
                    <span class=month>Sept</span>
                ...
                <div class="main d-flex flex-column justify-content-between">
                  <span class="main_price event-price">$ 20</span>
                  <h4 class=main_title>A business process is a collection of linked tasks in Europe</h4>
                  <p class=main_text>Vestibulum eget magna aliquet, ultrices arcu non, suscipit urna. Aliquam porta, lorem eu dictum rutrum</p>
                  <a class="main_btn btn btn--bordered btn--arrow" href=#>sign up for a course <i class="icon-arrow-right-solid icon"></i>
                  </a>
                </div>
            ...
            <li class="list_events-card col-md-6 col-lg-4" data-aos=fade-up data-order=6>
              <div class="card-wrapper d-flex flex-column">
                <div class=media>
                  <picture>
                    <source data-srcset=img/events/06.webp srcset=img/events/06.webp>
                    <img class=lazy data-src=img/events/06.jpg src=img/events/06.jpg alt=media>
                  </picture>
                  <span class=event-date>
                    <span class=day>18</span>
                    <span class=month>Feb</span>
                ...
                <div class="main d-flex flex-column justify-content-between">
                  <span class="main_price event-price">Free for subscribers</span>
                  <h4 class=main_title>Machine learning is the science of getting computers to act</h4>
                  <p class=main_text>Vestibulum eget magna aliquet, ultrices arcu non, suscipit urna. Aliquam porta, lorem eu dictum rutrum</p>
                  <a class="main_btn btn btn--bordered btn--arrow" href=#>sign up for a course <i class="icon-arrow-right-solid icon"></i>
                  </a>
                </div>
