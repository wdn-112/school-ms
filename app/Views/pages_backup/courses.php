...
<html lang=en>
  ...
  <body>
    ...
    <header class=header data-page=courses>
    ...
    <main>
      ...
      <section class=sale>
        <div class=sale_deco>
          <picture>
            <source data-srcset=img/course/sale.webp srcset=img/course/sale.webp>
            <img class=lazy data-src=img/course/sale.jpg src=404.html alt=media>
          </picture>
        </div>
        <div class=container>
