...
<html lang=en>
  ...
  <body>
    ...
    <main>
              ...
              <div class=card>
                <div class=content>
                  ...
                  <div class=card_main>
                    ...
                    <p class=card_main-text>Sed a eros sodales diam sagittis faucibus. Cras id erat nisl. Fusce faucibus nulla sed finibus.</p>
                  </div>
                </div>
              </div>
            </li>
              ...
              <div class=card>
                <div class=content>
                  ...
                  <div class=card_main>
                    ...
                    <p class=card_main-text>Donec urna massa, cursus venenatis ipsum et, tempus rhoncus tortor. Mauris nunc nisl, pharetra eu.</p>
                  </div>
                </div>
              </div>
            </li>
              ...
              <div class=card>
                <div class=content>
                  ...
                  <div class=card_main>
                    ...
                    <p class=card_main-text>Vivamus odio tellus, tincidunt rutrum ligula ut, ornare gravida urna. Nullam vel dolor eu erat.</p>
                  </div>
                </div>
              </div>
            </li>
              ...
              <div class=card>
                <div class=content>
                  ...
                  <div class=card_main>
                    ...
                    <p class=card_main-text>Morbi sit amet tortor vel nibh fringilla lobortis vel vel felis. Praesent turpis enim, fringilla vitae ligula vitae.</p>
                  </div>
                </div>
              </div>
            </li>
      ...
      <section class="infoblock d-flex flex-column flex-lg-row flex-md-wrap">
        <div class="infoblock_block col-lg-6 d-flex flex-column justify-content-center align-items-center" data-order=1>
          <div class=content>
            ...
            <p class=infoblock_block-text>The best educational programs and opportunities for fast and effective learning. New professions, new opportunities and ways of working. You can learn more</p>
          </div>
        </div>
        ...
        <div class="infoblock_block col-lg-6 infoblock_block--sale d-flex flex-column justify-content-center align-items-center" data-order=4>
          <div class="content d-flex flex-column flex-sm-row align-items-center align-items-sm-start">
            ...
            <div class="content_text d-flex flex-column align-items-center align-items-xl-start">
              ...
              <p class=text>Unlimited access to educational materials <span class=text_cut>and lectures</span>
              </p>
            </div>
          </div>
        ...
        <div class=container>
          ...
          <div class=reviews_slider>
            ...
            <div class=swiper-wrapper>
              ...
              <div class="reviews_slider-slide swiper-slide">
                <q class=quote>“Donec molestie eros dolor. Nulla sed suscipit lectus. Phasellus rhoncus vulputate odio et placerat. Aenean ut aliquam erat. Integer rutrum eleifend ante, a bibendum leo tristique id. Phasellus euismod sapien non ornare sagittis. Curabitur laoreet neque at magna pulvinar cursus. Nulla euismod orci in varius mollis”</q>
                <div class="author d-flex flex-column align-items-center">
                  <span class=avatar>
                    <picture>
              ...
              <div class="reviews_slider-slide swiper-slide">
                <q class=quote>“Curabitur laoreet neque at magna pulvinar cursus. Nulla sed suscipit lectus. Phasellus rhoncus vulputate odio et placerat. Aenean ut aliquam erat. Integer rutrum eleifend ante, a bibendum leo tristique id. Phasellus euismod sapien non ornare sagittis. Donec molestie eros dolor. Nulla euismod orci in varius mollis”</q>
                <div class="author d-flex flex-column align-items-center">
                  <span class=avatar>
                    <picture>
                      <source data-srcset=img/reviews/04.webp srcset=img/reviews/04.webp>
                      <img class=lazy data-src=img/reviews/04.jpg src=img/reviews/04.jpg alt=media>
                    </picture>
                  </span>
              ...
              <div class="reviews_slider-slide swiper-slide">
                ...
                <div class="author d-flex flex-column align-items-center">
                  <span class=avatar>
                    <picture>
                      <source data-srcset=img/reviews/05.webp srcset=img/reviews/05.webp>
                      <img class=lazy data-src=img/reviews/05.jpg src=img/reviews/05.jpg alt=media>
                    </picture>
                  </span>
      ...
      <section class=faq>
        <div class=phone>
          <lottie-player src=lottie/phone.json background=404.html speed=1 style="width: 100%; height: 100%" loop autoplay></lottie-player>
        </div>
        <div class=sphere>
          <lottie-player src=lottie/sphere.json background=404.html speed=1.5 style="width: 100%; height: 100%" loop autoplay></lottie-player>
        </div>
        <div class="container d-flex flex-column align-items-center">
          <div class=faq_header>
            <h2 class=faq_header-title data-aos=fade-down>Answering your common questions</h2>
            <p class=faq_header-text data-aos=fade-up>Sed a eros sodales diam sagittis faucibus. Cras id erat nisl. Fusce faucibus nulla sed finibus egestas. Vestibulum purus magna, auctor consectetur sem nec, consectetur porta purus.</p>
          </div>
            ...
            <div class=faq_accordion-item>
              <div class=item-wrapper>
                ...
                <div id=item-1 class="accordion-collapse collapse show">
                  <div class=faq_accordion-item_body>Nam quis facilisis magna, sit amet posuere tellus. Donec imperdiet tortor vitae pharetra congue. Aliquam nunc est, iaculis in erat lobortis, convallis varius mi. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Aliquam vel suscipit nisi, et imperdiet nulla. Praesent condimentum metus aliquet venenatis feugiat. Nunc at iaculis nisl. Donec ultrices placerat euismod</div>
                </div>
              </div>
            </div>
            <div class=faq_accordion-item>
          ...
          <a class="faq_btn btn--arrow" href=faq.html>View all <i class="icon-arrow-right-solid icon"></i>
          </a>
        </div>
      </section>
    </main>
