...
<html lang=en>
  ...
  <body>
    ...
    <header class=header data-page=pricing>
    ...
    <main>
      ...
      <section class=hero>
        <div class="container d-lg-flex flex-row-reverse align-items-center">
          <div class="hero_main col-lg-6">
            ...
            <p class=hero_main-text data-aos=fade-left data-aos-delay=50>Sed a eros sodales diam sagittis faucibus. Cras id erat nisl. Fusce faucibus nulla sed finibus egestas. Vestibulum purus magna, auctor consectetur sem nec, consectetur porta purus. Duis eget nisi eleifend, laoreet lacus</p>
          </div>
      ...
      <section class=pricing>
        <div class=container>
          ...
          <p class=pricing_text>Uisque vehicula tellus ex, pulvinar varius massa pulvinar quis. Phasellus varius leo sit amet nisl auctor iaculis. Aliquam sem odio, vulputate et nisi at, dapibus cursus libero. Donec rhoncus tristique</p>
        </div>
      </section>
      <section class=faq>
        <div class=phone>
