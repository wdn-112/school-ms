...
<html lang=en>
  ...
  <body>
    ...
    <header class=header data-page=journal>
      ...
      <div class=page_main>
        ...
        <div class=container>
          <div class=content-wrapper>
            <h1 class=page_main-header>Journal</h1>
      ...
      <div class="container d-flex flex-column flex-lg-row justify-content-between">
        ...
        <div class=content>
          <ul class=journal_list>
            <li class=journal_list-item data-order=1>
              <div class=media>
                <picture>
                  <source data-srcset=img/journal/01.webp srcset=img/journal/01.webp>
                  <img class=lazy data-src=img/journal/01.jpg src=img/journal/01.jpg alt=media>
              ...
              <div class=main>
                <ul class="main_meta d-flex flex-wrap">
                  <li class="main_meta-item d-flex align-items-center">
                    <i class="icon-clock-solid icon"></i> February 07, 2021
                  </li>
                  <li class="main_meta-item d-flex align-items-center">
                ...
                <a class="main_title h3" href=post.html target=_blank rel="noopener noreferrer">AR Smart Glasses Used for Business Success in 2020</a>
                <p class=main_text>In this sequence of four courses, you will summarize and demonstrate all stages of the UI/UX development process, from user research to defining a project’s strategy, scope, and information architecture, to developing sitemaps and wireframes</p>
                <a class="main_btn btn" href=post.html>
                  <span class=text>Read more</span>
                </a>
              </div>
            </li>
            <li class=journal_list-item data-order=2>
              <div class=media>
                <picture>
                  <source data-srcset=img/journal/02.webp srcset=img/journal/02.webp>
                  <img class=lazy data-src=img/journal/02.jpg src=img/journal/02.jpg alt=media>
                </picture>
              </div>
              <div class=main>
                <ul class="main_meta d-flex flex-wrap">
                ...
                <a class="main_title h3" href=post.html target=_blank rel="noopener noreferrer">Crypto Market Anomalies - December 2020 Edition</a>
                <p class=main_text>In this sequence of four courses, you will summarize and demonstrate all stages of the UI/UX development process, from user research to defining a project’s strategy, scope, and information architecture, to developing sitemaps and wireframes</p>
                <a class="main_btn btn" href=post.html>
                  <span class=text>Read more</span>
                </a>
            ...
            <li class=journal_list-item data-order=3>
              <div class=media>
                <picture>
                  <source data-srcset=img/journal/03.webp srcset=img/journal/03.webp>
                  <img class=lazy data-src=img/journal/03.jpg src=img/journal/03.jpg alt=media>
                </picture>
              </div>
              <div class=main>
                <ul class="main_meta d-flex flex-wrap">
                ...
                <a class="main_title h3" href=post.html target=_blank rel="noopener noreferrer">Adopting a Mature Engineering Organization in Startups</a>
                <p class=main_text>In this sequence of four courses, you will summarize and demonstrate all stages of the UI/UX development process, from user research to defining a project’s strategy, scope, and information architecture, to developing sitemaps and wireframes</p>
                <a class="main_btn btn" href=post.html>
                  <span class=text>Read more</span>
                </a>
      ...
      <div class="banner orange">
        ...
        <div class="container d-lg-flex align-items-center">
          ...
          <div class=banner_media>
            <picture>
              <source data-srcset=img/banners/journal.webp srcset=img/banners/journal.webp>
              <img class=lazy data-src=img/banners/journal.jpg src=img/banners/journal.jpg alt=media>
            </picture>
          </div>
        </div>
      </div>
