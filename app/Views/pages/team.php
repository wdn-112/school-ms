...
<html lang=en>
  ...
  <body>
    ...
    <header class=header data-page=team>
      ...
      <section class=team>
        <div class=container>
          <ul class="team_list d-flex flex-wrap">
            <li class="team_list-item col-sm-6 col-lg-4 col-xl-3" data-aos=fade-up data-order=1 data-media=img/team/01>
              <div class=media>
                <picture>
                  <source data-srcset=img/team/01.webp srcset=img/team/01.webp>
                  <img class=lazy data-src=img/team/01.jpg src=img/team/01.jpg alt=media>
                </picture>
              </div>
              <div class=main>
            ...
            <li class="team_list-item col-sm-6 col-lg-4 col-xl-3" data-aos=fade-up data-order=2 data-media=img/team/02>
              <div class=media>
                <picture>
                  <source data-srcset=img/team/02.webp srcset=img/team/02.webp>
                  <img class=lazy data-src=img/team/02.jpg src=img/team/02.jpg alt=media>
                </picture>
              </div>
              <div class=main>
                <h5 class=name>Ph.D. David Mollstein</h5>
                <span class=profession>Master of Business Administration</span>
              </div>
            </li>
            <li class="team_list-item col-sm-6 col-lg-4 col-xl-3" data-aos=fade-up data-order=3 data-media=img/team/03>
              <div class=media>
                <picture>
                  <source data-srcset=img/team/03.webp srcset=img/team/03.webp>
                  <img class=lazy data-src=img/team/03.jpg src=img/team/03.jpg alt=media>
                </picture>
              </div>
              <div class=main>
                <h5 class=name>LL.D. Nataniel Govard</h5>
                <span class=profession>Writer, politician, lecturer</span>
              </div>
            </li>
            <li class="team_list-item col-sm-6 col-lg-4 col-xl-3" data-aos=fade-up data-order=4 data-media=img/team/04>
              <div class=media>
                <picture>
                  <source data-srcset=img/team/04.webp srcset=img/team/04.webp>
                  <img class=lazy data-src=img/team/04.jpg src=img/team/04.jpg alt=media>
                </picture>
              </div>
              <div class=main>
                <h5 class=name>Ph.D. Adam Mosshart</h5>
                <span class=profession>Product&Project Management</span>
              </div>
            </li>
            <li class="team_list-item col-sm-6 col-lg-4 col-xl-3" data-aos=fade-up data-order=5 data-media=img/team/05>
              <div class=media>
                <picture>
                  <source data-srcset=img/team/05.webp srcset=img/team/05.webp>
                  <img class=lazy data-src=img/team/05.jpg src=img/team/05.jpg alt=media>
                </picture>
              </div>
              <div class=main>
                <h5 class=name>D.C.S. Liam Solveig</h5>
                <span class=profession>CEO, Lead Instructor</span>
              </div>
            </li>
            <li class="team_list-item col-sm-6 col-lg-4 col-xl-3" data-aos=fade-up data-order=6 data-media=img/team/06>
              <div class=media>
                <picture>
                  <source data-srcset=img/team/06.webp srcset=img/team/06.webp>
                  <img class=lazy data-src=img/team/06.jpg src=img/team/06.jpg alt=media>
                </picture>
              </div>
              <div class=main>
            ...
            <li class="team_list-item col-sm-6 col-lg-4 col-xl-3" data-aos=fade-up data-order=7 data-media=img/team/07>
              <div class=media>
                <picture>
                  <source data-srcset=img/team/07.webp srcset=img/team/07.webp>
                  <img class=lazy data-src=img/team/07.jpg src=img/team/07.jpg alt=media>
                </picture>
              </div>
              <div class=main>
            ...
            <li class="team_list-item col-sm-6 col-lg-4 col-xl-3" data-aos=fade-up data-order=8 data-media=img/team/08>
              <div class=media>
                <picture>
                  <source data-srcset=img/team/08.webp srcset=img/team/08.webp>
                  <img class=lazy data-src=img/team/08.jpg src=img/team/08.jpg alt=media>
                </picture>
              </div>
              <div class=main>
            ...
            <li class="team_list-item col-sm-6 col-lg-4 col-xl-3" data-aos=fade-up data-order=9 data-media=img/team/09>
              <div class=media>
                <picture>
                  <source data-srcset=img/team/09.webp srcset=img/team/09.webp>
                  <img class=lazy data-src=img/team/09.jpg src=img/team/09.jpg alt=media>
                </picture>
              </div>
              <div class=main>
                <h5 class=name>D.C.S. Liam Solveig</h5>
            ...
            <li class="team_list-item col-sm-6 col-lg-4 col-xl-3" data-aos=fade-up data-order=10 data-media=img/team/10>
              <div class=media>
                <picture>
                  <source data-srcset=img/team/10.webp srcset=img/team/10.webp>
                  <img class=lazy data-src=img/team/10.jpg src=img/team/10.jpg alt=media>
                </picture>
              </div>
              <div class=main>
                <h5 class=name>Oleta Carroll</h5>
            ...
            <li class="team_list-item col-sm-6 col-lg-4 col-xl-3" data-aos=fade-up data-order=11 data-media=img/team/11>
              <div class=media>
                <picture>
                  <source data-srcset=img/team/11.webp srcset=img/team/11.webp>
                  <img class=lazy data-src=img/team/11.jpg src=img/team/11.jpg alt=media>
                </picture>
              </div>
              <div class=main>
                <h5 class=name>Dejuan Maggio</h5>
                <span class=profession>Mobile & Web developer</span>
              </div>
            </li>
            <li class="team_list-item col-sm-6 col-lg-4 col-xl-3" data-aos=fade-up data-order=12 data-media=img/team/12>
              <div class=media>
                <picture>
                  <source data-srcset=img/team/12.webp srcset=img/team/12.webp>
                  <img class=lazy data-src=img/team/12.jpg src=img/team/12.jpg alt=media>
                </picture>
              </div>
              <div class=main>
                <h5 class=name>Martin Solveig</h5>
                <span class=profession>Product&Project Management</span>
              </div>
            </li>
          </ul>
