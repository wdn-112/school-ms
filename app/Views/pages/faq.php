...
<html lang=en>
  ...
  <body>
    ...
    <header class=header data-page=faq>
      ...
      <div class=page_main>
        ...
        <div class=container>
          <div class=content-wrapper>
            <h1 class=page_main-header>FAQ</h1>
    ...
    <main>
      <div class=cards>
        <div class=container>
          <ul class="cards_list d-md-flex flex-wrap justify-content-center">
            <li class=cards_list-item>
              <div class=card>
                <div class=content>
                  <div class="card_media card_media--bg">
                    <i class="icon-indent-solid icon"></i>
                  </div>
                  <div class=card_main>
                    <h5 class=card_main-title>Getting Started Guide</h5>
                    <p class=card_main-text>Aliquam erat volutpat. Suspendisse id libero dolor. Proin hendrerit eros vitae lorem facilisis, et vulputate</p>
                    <a class="card_main-link btn--arrow" href=#>Read more <i class="icon-arrow-right-solid icon"></i>
                    </a>
                  </div>
                </div>
              </div>
            ...
            <li class=cards_list-item>
              <div class=card>
                <div class=content>
                  ...
                  <div class=card_main>
                    <h5 class=card_main-title>Payment & Account</h5>
                    <p class=card_main-text>Aliquam erat volutpat. Suspendisse id libero dolor. Proin hendrerit eros vitae lorem facilisis, et vulputate</p>
                    <a class="card_main-link btn--arrow" href=#>Read more <i class="icon-arrow-right-solid icon"></i>
                    </a>
                  </div>
      ...
      <section class=faq>
        <div class=container>
          <div class=faq_header>
            <h2 class=faq_header-title>Getting Started Guide</h2>
            <p class=faq_header-text>Sed a eros sodales diam sagittis faucibus. Cras id erat nisl. Fusce faucibus nulla sed finibus egestas. Vestibulum purus magna, auctor consectetur sem nec, consectetur porta purus.</p>
          </div>
          <div class=faq_accordion id=faq_accordion>
            <div class=faq_accordion-item>
              <div class=item-wrapper>
                <h4 class="faq_accordion-item_header d-flex justify-content-between align-items-center collapsed" data-bs-toggle=collapse data-bs-target=#item-1 aria-expanded=true>
                  <span class=text>What ante quis tincidunt porta, neque metus dapibus velit, porta aliquam nisi est quis turpis? </span>
                ...
                <div id=item-1 class="accordion-collapse collapse show">
                  <div class=faq_accordion-item_body>
                    <div class=media>
                      <picture>
                        <source data-srcset=img/faq/01.webp srcset=img/faq/01.webp>
                        <img class=lazy data-src=img/faq/01.jpg src=img/faq/01.jpg alt=media>
                      </picture>
                    </div>
                    <div class=main>
                      <p class=main_text>Proin egestas at neque et scelerisque. Phasellus venenatis erat ac nunc pellentesque, at vehicula massa efficitur. Nam feugiat neque eget nisi faucibus cursus. Quisque et condimentum est. Pellentesque vehicula lorem elit, sit amet congue odio faucibus in. Proin id condimentum neque. Suspendisse commodo ac magna at congue. Sed nec tempus lacus, commodo pellentesque ligula. Suspendisse potenti. Praesent lacinia urna in imperdiet feugiat. Fusce sed tincidunt eros</p>
                      <ul class=main_list>
                        <li class=main_list-item>Maecenas id eros efficitur, consectetur nulla id, venenatis massa. Pellentesque volutpat nec metus a commodo. Praesent efficitur eros ut nulla pulvinar pretium. Morbi ultrices ipsum in nulla vehicula pellentesque</li>
                        <li class=main_list-item>Pellentesque volutpat nec metus a commodo. Praesent efficitur eros ut nulla pulvinar pretium. Morbi ultrices ipsum in nulla vehicula pellentesque</li>
                      </ul>
                    </div>
                  </div>
                </div>
            ...
            <div class=faq_accordion-item>
              <div class=item-wrapper>
                <h4 class="faq_accordion-item_header d-flex justify-content-between align-items-center collapsed" data-bs-toggle=collapse data-bs-target=#item-2 aria-expanded=false>
                  <span class=text>What ante quis tincidunt porta, neque metus dapibus velit, porta aliquam nisi est quis turpis? </span>
                ...
                <div id=item-2 class="accordion-collapse collapse">
                  <div class=faq_accordion-item_body>
                    <div class=media>
                      <picture>
                        <source data-srcset=img/faq/02.webp srcset=img/faq/02.webp>
                        <img class=lazy data-src=img/faq/02.jpg src=img/faq/02.jpg alt=media>
                      </picture>
                    </div>
                    <div class=main>
                      <p class=main_text>Nam quis facilisis magna, sit amet posuere tellus. Donec imperdiet tortor vitae pharetra congue. Aliquam nunc est, iaculis in erat lobortis, convallis varius mi. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Aliquam vel suscipit nisi, et imperdiet nulla. Praesent condimentum metus aliquet venenatis feugiat. Nunc at iaculis nisl. Donec ultrices placerat euismod</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class=faq_accordion-item>
              <div class=item-wrapper>
                <h4 class="faq_accordion-item_header d-flex justify-content-between align-items-center collapsed" data-bs-toggle=collapse data-bs-target=#item-3 aria-expanded=false>
                  <span class=text>What ante quis tincidunt porta, neque metus dapibus velit, porta aliquam nisi est quis turpis? </span>
                  <span class=icon></span>
                </h4>
                <div id=item-3 class="accordion-collapse collapse">
                  <div class=faq_accordion-item_body>
                    <div class=media>
                      <picture>
                        <source data-srcset=img/faq/03.webp srcset=img/faq/03.webp>
                        <img class=lazy data-src=img/faq/03.jpg src=img/faq/03.jpg alt=media>
                      </picture>
                    </div>
                    <div class=main>
                      <p class=main_text>Nam quis facilisis magna, sit amet posuere tellus. Donec imperdiet tortor vitae pharetra congue. Aliquam nunc est, iaculis in erat lobortis, convallis varius mi. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Aliquam vel suscipit nisi, et imperdiet nulla. Praesent condimentum metus aliquet venenatis feugiat. Nunc at iaculis nisl. Donec ultrices placerat euismod</p>
            ...
            <div class=faq_accordion-item>
              <div class=item-wrapper>
                <h4 class="faq_accordion-item_header d-flex justify-content-between align-items-center collapsed" data-bs-toggle=collapse data-bs-target=#item-4 aria-expanded=false>
                  <span class=text>What ante quis tincidunt porta, neque metus dapibus velit, porta aliquam nisi est quis turpis? </span>
                  <span class=icon></span>
                </h4>
                <div id=item-4 class="accordion-collapse collapse">
                  <div class=faq_accordion-item_body>
                    <div class=media>
                      <picture>
                        <source data-srcset=img/faq/04.webp srcset=img/faq/04.webp>
                        <img class=lazy data-src=img/faq/04.jpg src=img/faq/04.jpg alt=media>
                      </picture>
                    </div>
                    <div class=main>
                      <p class=main_text>Nam quis facilisis magna, sit amet posuere tellus. Donec imperdiet tortor vitae pharetra congue. Aliquam nunc est, iaculis in erat lobortis, convallis varius mi. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Aliquam vel suscipit nisi, et imperdiet nulla. Praesent condimentum metus aliquet venenatis feugiat. Nunc at iaculis nisl. Donec ultrices placerat euismod</p>
      ...
      <section class=contacts_form>
        <div class=container>
          <div class=contacts_form-header>
            ...
            <ul class="contacts_form-header_list d-md-flex justify-content-between">
              <li class=list-item>
                <div class=wrapper>
                  <div class=content>
                    <div class="block d-flex flex-column align-items-start">
                      <span class="content_text text d-inline-flex align-items-center">
                        <i class="icon-map-marker-alt-solid icon"></i> 61 Wood Ave. </span>
                      <span class="content_text text d-inline-flex align-items-center">
                        <span class=helper></span> Holly Springs, NC 27540 </span>
                    </div>
                  </div>
                </div>
              </li>
                ...
                <div class=wrapper>
                  <div class="content align-items-start">
                    <div class="block d-flex flex-column">
                      <a class="content_link text d-inline-flex align-items-center" href=tel:+1234567890>
                        <i class="icon-phone-solid icon"></i> +1-202-555-0150 </a>
                      <a class="content_link text d-inline-flex align-items-center" href=tel:+1234567890>
                        <span class=helper></span> +1-202-555-0151 </a>
                    </div>
                  </div>
                </div>
              </li>
              <li class=list-item>
                <div class=wrapper>
                  <div class=content>
                    <div class="block d-flex flex-column align-items-start">
                      <a class="content_link d-inline-flex align-items-center text" href=# target=_blank rel="noopener noreferrer">
                        <i class="icon-twitter icon"></i> @acadescourses </a>
                      <a class="content_link d-inline-flex align-items-center text" href=# target=_blank rel="noopener noreferrer">
                        <i class="icon-whatsapp icon"></i> @whacadescourses </a>
                    </div>
                  </div>
                </div>
              </li>
            </ul>
            <p class="contacts_form-header_text text">If you have any questions leave your request: we will be happy to answer all your questions.</p>
          </div>
