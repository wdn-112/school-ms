...
<html lang=en>
  <head>
    ...
    <title>Adopting a Mature Engineering Organization in Startups | Edison</title>
      ...
      <div class=page_breadcrumbs>
        <div class=container>
          <ul class="page_breadcrumbs-list d-flex flex-wrap align-items-center">
            ...
            <li class=list-item>Adopting a Mature Engineering Organization in Startups</li>
          </ul>
        </div>
      </div>
    </header>
    <main>
            ...
            <div class="sidebar_block sidebar_block--recent">
              <ul class=list>
                <li class=list-item>
                  <div class=media>
                    <picture>
                      <source data-srcset=img/journal/01.webp srcset=img/journal/01.webp>
                      <img class=lazy data-src=img/journal/01.jpg src=img/journal/01.jpg alt=media>
                    </picture>
                  </div>
                  <div class=main>
                    <a class="main_title h5" href=post.html>Authors of New Yorker illustrations about working with color and composition</a>
                    <ul class="main_meta d-flex align-items-center">
                      <li class="main_meta-item d-flex align-items-center">
                        <i class="icon-clock-solid icon"></i> February 07, 2021
                      </li>
                      <li class="main_meta-item d-flex align-items-center">
                        <i class="icon-user-solid icon"></i> Miranda Dawson
                      </li>
                    </ul>
                  </div>
                </li>
                <li class=list-item>
                  <div class=media>
                    <picture>
                      <source data-srcset=img/course/hero.webp srcset=img/course/hero.webp>
                      <img class=lazy data-src=img/course/hero.jpg src=img/course/hero.jpg alt=media>
                    </picture>
                  </div>
                  <div class=main>
                    <a class="main_title h5" href=post.html>Self-taught web developer proves that anything is possible</a>
                    <ul class="main_meta d-flex align-items-center">
                      <li class="main_meta-item d-flex align-items-center">
                        <i class="icon-clock-solid icon"></i> February 07, 2021
                      </li>
          ...
          <div class=post_content>
            <article class=post_content-article>
              <div class=post_content-article_header>
                <h2 class=title>Adopting a Mature Engineering Organization in Startups</h2>
                <div class=media>
                  <picture>
                    <source data-srcset=img/about/infoblock3.webp srcset=img/about/infoblock3.webp>
                    <img class=lazy data-src=img/about/infoblock3.jpg src=img/about/infoblock3.jpg alt=media>
                  </picture>
                </div>
                <ul class="metadata d-flex flex-wrap">
                  ...
                  <li class="metadata_item d-flex align-items-center">
                    <i class="icon-user-solid icon"></i> Jane Doe
                  </li>
                  <li class="metadata_item d-flex align-items-center">
                    <i class="icon-link-solid icon"></i> Programming
                  </li>
                </ul>
              </div>
              <h4 class=post_content-article_subtitle>As a result, we were extra-proud to discover that people are also turning to our platform as a resource to teach–with course creation jumping by 55%</h4>
              <div class=post_content-article_block>
                <p class=text>In this sequence of four courses, you will summarize and demonstrate all stages of the UI/UX development process, from user research to defining a project’s strategy, scope, and information architecture, to developing sitemaps and wireframes. Nam pharetra leo vel dolor posuere maximus. Nulla a aliquam sapien. Nullam et odio vel dolor laoreet scelerisque. Nulla ac justo libero. Vivamus vitae dictum semelit.</p>
                <p class=text>Vestibulum auctor nisi vel dolor laoreet, quis fringilla enim facilisis. Nulla euismod est non dignissim bibendum. Nam maximus sem ut convallis maximus. Nulla auctor risus et magna ultrices suscipit. Nulla ut justo eget ligula posuere bibendum. Suspendisse ut ex purus. Aenean et euismod nisl.</p>
              </div>
              <div class="post_content-article_gallery d-grid post-gallery">
                <div class=media>
                  <a href=img/post/full01.jpg data-caption="Image caption">
                    <picture>
                      <source data-srcset=img/post/01.webp srcset=img/post/01.webp>
                      <img class=lazy data-src=img/post/01.jpg src=img/post/01.jpg alt=media>
                    </picture>
                  </a>
                </div>
                <div class=media>
                  <a href=img/post/full02.jpg data-caption="Image caption">
                    <picture>
                      <source data-srcset=img/post/02.webp srcset=img/post/02.webp>
                      <img class=lazy data-src=img/post/02.jpg src=img/post/02.jpg alt=media>
                    </picture>
                  </a>
                </div>
              </div>
              <div class=post_content-article_block>
                <p class=text>In et condimentum arcu. Vivamus eget laoreet nunc. Donec molestie venenatis condimentum. Phasellus egestas eu odio id mattis. Duis lacinia et dolor nec ornare. Donec justo odio, tempus nec risus et, varius tempor turpis. Praesent quam tellus, interdum vitae mi ut, condimentum tristique nisi. Quisque lobortis leo odio.</p>
                <p class=text>Tristique eros proin pharetra ut risus ac convallis. Duis vestibulum dolor a varius commodo. Nam fringilla sed lectus eget pellentesque. Nullam eu sapien ullamcorper, eleifend lorem ultricies, commodo ligula. Nunc a mauris congue elit auctor ullamcorper.</p>
              </div>
              <div class=post_content-article_quote>
                <i class="icon-quote-left-solid icon"></i>
                <q class=quote>Nulla sed suscipit lectus. Phasellus rhoncus vulputate odio et placerat. Aenean ut aliquam erat. Integer rutrum eleifend ante, a bibendum leo tristique id. Phasellus euismod sapien non ornare sagittis. Donec molestie eros dolor. Curabitur laoreet neque at magna pulvinar cursus. Nulla euismod orci in varius mollis.</q>
              </div>
              <div class=post_content-article_block>
                <p class=text>Praesent hendrerit neque nisl, at gravida mauris auctor et. Pellentesque eleifend ut risus eget hendrerit. Vivamus vel dolor ligula. Sed nec egestas est. Fusce sed neque eget metus dictum dictum at id sem. Curabitur convallis viverra erat, a posuere diam bibendum eget. Cras consequat interdum nunc nec sollicitudin.</p>
                <p class=text>Vivamus placerat placerat lectus id congue. Suspendisse consequat pellentesque fringilla. Fusce vel ipsum feugiat, interdum elit et, tincidunt sapien. Suspendisse orci est, lacinia sit amet enim vitae.</p>
              </div>
              <div class="post_content-article_share d-flex justify-content-between justify-content-sm-start">
                <a class="link link--facebook d-inline-flex align-items-center justify-content-center" href=#>
                  <i class="icon-facebook icon"></i> Facebook </a>
                <a class="link link--twitter d-inline-flex align-items-center justify-content-center" href=#>
                  <i class="icon-twitter icon"></i> Twitter </a>
              </div>
            </article>
            <section class=post_content-footer>
              <div class=post_content-footer_recommended>
                ...
                <div class="content d-md-flex justify-content-between">
                  <div class=content_block>
                    <div class=media>
                      <picture>
                        ...
                        <img class=lazy data-src=img/about/cover.jpg src=img/about/cover.jpg alt=media>
                      </picture>
                    </div>
                    <div class=main>
                      <a class="main_title h5" href=#>Self-taught web developer proves that anything is possible</a>
                      <ul class="main_meta d-flex align-items-center">
                        <li class="main_meta-item d-flex align-items-center">
                          <i class="icon-clock-solid icon"></i> February 07, 2021
                        </li>
                  ...
                  <div class=content_block>
                    <div class=media>
                      <picture>
                        <source data-srcset=img/post/recommended02.webp srcset=img/post/recommended02.webp>
                        <img class=lazy data-src=img/post/recommended02.jpg src=img/post/recommended02.jpg alt=media>
                      </picture>
                    </div>
                    <div class=main>
                      <a class="main_title h5" href=#>Discover the trends that will define the future of work</a>
                      <ul class="main_meta d-flex align-items-center">
                        <li class="main_meta-item d-flex align-items-center">
                          <i class="icon-clock-solid icon"></i> February 07, 2021
                        </li>
              ...
              <div class="post_content-footer_author d-flex flex-column flex-sm-row align-items-center align-items-sm-start">
                <div class=avatar>
                  <picture>
                ...
                <div class=about>
                  <span class="about_title text">Author</span>
                  <h4 class=about_name>Joan Smith</h4>
                  <p class="about_bio text">Donec justo odio, tempus nec risus et, varius tempor turpis. Praesent quam tellus, interdum vitae mi ut, condimentum tristique nisi. Quisque lobortis leo odio. Nullam eu sapien ullamcorper, eleifend lorem ultricies, commodo ligula. Nunc a mauris congue elit auctor ullamcorpert</p>
                  <ul class="about_socials d-flex align-items-center">
                    <li class=about_socials-item>
                      <a class=link href=# target=_blank rel="noopener noreferrer">
                        <i class=icon-facebook></i>
                      </a>
                    </li>
            ...
            <section class=post_content-reply>
              <h3 class=post_content-reply_title>Leave a Comment:</h3>
              <form class=post_content-reply_form action=# method=post data-type=reply>
                <div class="field-wrapper d-sm-flex justify-content-between">
                ...
                <textarea class="field required" placeholder="Your comment here"></textarea>
                <div class="wrapper d-flex flex-wrap align-items-center justify-content-center justify-content-sm-start">
                  <div class=checkbox>
            ...
            <section class=post_content-comments>
              <h4 class=post_content-comments_title>Recent comments:</h4>
              <ul class=post_content-comments_list>
                <li class="comment d-flex align-items-start">
                  <div class=comment_media>
                    <picture>
                      <source data-srcset=img/reviews/02.webp srcset=img/reviews/02.webp>
                      <img class=lazy data-src=img/reviews/02.jpg src=img/reviews/02.jpg alt=media>
                    </picture>
                  </div>
                  <div class=comment_main>
                    <div class="comment_main-panel d-sm-flex align-items-center justify-content-between">
                      <div class="comment_main-panel_data d-flex flex-column">
                        <span class="name h5">Lindon Price</span>
                        <span class="timestamp text text--sm">March 01,2021 at 12:02 pm</span>
                      </div>
                      <a class="comment_main-panel_btn btn" href=#>Reply</a>
                    </div>
                    <p class=comment_main-content>Aenean tincidunt augue magna, vel commodo ligula pharetra nec. Integer convallis felis leo. Sed luctus mi posuere orci semper faucibus. Aliquam id mauris in felis condimentum tristique</p>
                  </div>
                </li>
                <li class="comment d-flex align-items-start" data-reply=true>
                  <div class=comment_media>
                    <picture>
                      <source data-srcset=img/reviews/03.webp srcset=img/reviews/03.webp>
                      <img class=lazy data-src=img/reviews/03.jpg src=img/reviews/03.jpg alt=media>
                    </picture>
                  </div>
                  <div class=comment_main>
                    <div class="comment_main-panel d-sm-flex align-items-center justify-content-between">
                      <div class="comment_main-panel_data d-flex flex-column">
                        <span class="name h5">Cameron Fernando</span>
                        <span class="timestamp text text--sm">March 01,2021 at 12:02 pm</span>
                      </div>
                      <a class="comment_main-panel_btn btn" href=#>Reply</a>
                    </div>
      ...
      <section class=subscribe>
        <div class=subscribe_circle>
          <div class=subscribe_circle-circle></div>
        </div>
        <div class=subscribe_img>
          <picture>
            <source data-srcset=img/faq/setting.webp srcset=img/faq/setting.webp>
            <img class=lazy data-src=img/faq/setting.jpg src=404.html alt=media>
          </picture>
        </div>
        <div class=container>
          <div class="subscribe_main d-flex flex-column align-items-center align-items-xl-start">
            <h3 class=subscribe_main-title>Get Free Consultation</h3>
            <p class=subscribe_main-text>Nulla sed suscipit lectus. Phasellus rhoncus vulputate odio et placerat. Aenean ut aliquam erat. Integer rutrum eleifend ante, a bibendum leo tristique</p>
            <form class="subscribe_main-form d-sm-flex" action=# method=post>
