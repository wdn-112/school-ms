(() => {
	...
	function e(e) {
		return function(e) {
			...
			if (e) {
				...
				return "Object" === r && e.constructor && (r = e.constructor.name), "Map" === r || "Set" === r ? Array.from(e) : "Arguments" === r || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r) ? t(e, i) : void 0
			}
		}(e) || function() {
	...
	var i = function t(e, i) {
		...
		if (e && i && "object" == typeof e && "object" == typeof i) {
			...
			var r, s, n;
			if (Array.isArray(e)) {
				if ((r = e.length) != i.length) return !1;
				for (s = r; 0 != s--;)
			...
			if ((r = (n = Object.keys(e)).length) !== Object.keys(i).length) return !1;
			for (s = r; 0 != s--;)
	...
	class n {
		constructor({
			...
			if (this.CALLBACK = "__googleMapsCallback", this.callbacks = [], this.done = !1, this.loading = !1, this.errors = [], this.version = c, this.apiKey = t, this.channel = e, this.client = s, this.id = o || r, this.libraries = a, this.language = l, this.region = h, this.mapIds = u, this.nonce = d, this.retries = g, this.url = p, n.instance) {
				if (!i(this.options, n.instance.options)) throw new Error(`Loader must not be called again with different options. ${JSON.stringify(this.options)} !== ${JSON.stringify(n.instance.options)}`);
				return n.instance
			}
			n.instance = this
		}
