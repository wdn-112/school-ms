(() => {
		...
		updateSlides: function() {
			...
			for (let n = 0; n < p; n += 1) {
				...
				if (E && e.grid.updateSlide(n, a, p, t), "none" !== a.css("display")) {
					...
					c[n] && (c[n].swiperSlideSize = x), f.push(x), i.centeredSlides ? (T = T + x / 2 + y / 2 + b, 0 === y && 0 !== n && (T = T - r / 2 - b), 0 === n && (T = T - r / 2 - b), Math.abs(T) < .001 && (T = 0), i.roundLengths && (T = Math.floor(T)), S % i.slidesPerGroup == 0 && u.push(T), h.push(T)) : (i.roundLengths && (T = Math.floor(T)), (S - Math.min(e.params.slidesPerGroupSkip, S)) % e.params.slidesPerGroup == 0 && u.push(T), h.push(T), T = T + x + b), e.virtualSize += x + b, y = x, S += 1
				}
			}
	...
	const V = {
			attachEvents: function() {
				...
				e.onTouchStart = A.bind(e), e.onTouchMove = D.bind(e), e.onTouchEnd = G.bind(e), s.cssMode && (e.onScroll = _.bind(e)), e.onClick = N.bind(e), i.touch && !j && (t.addEventListener("touchstart", F), j = !0), H(e, "on")
			},
	...
	class J {
		constructor(...e) {
			...
			const i = this;
			i.__swiper__ = !0, i.support = x(), i.device = M({
				userAgent: s.userAgent
			}), i.browser = k(), i.eventsListeners = {}, i.eventsAnyListeners = [], i.modules = [...i.__modules__], s.modules && Array.isArray(s.modules) && i.modules.push(...s.modules);
			const n = {};
			i.modules.forEach((e => {
				e({
					swiper: i,
